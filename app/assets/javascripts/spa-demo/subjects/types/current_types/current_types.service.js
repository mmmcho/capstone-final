(function () {
  ...
  function CurrentTypes($rootScope, $q, $resource, currentOrigin, APP_CONFIG) {
    ...
    $rootScope.$watch(function () {
      return currentOrigin.getVersion();
    }, refresh);
    return;
    ...
    function refresh() {
      ...
      if (service.typeSearch.trim().length > 0){
        params['type'] = service.typeSearch.trim();
      }
  ...
  CurrentTypes.prototype.setCurrentTypeId = function (thing_id, image_id) {
    console.log("setCurrentType", thing_id, image_id);
